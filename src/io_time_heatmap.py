...
from src.iocurves.vis import io_curve, plot_compare_dcl
...
def iotime():
    ...
    static_runs, kcc2_runs = run_precise(inh_input=list(range(0, 22, 2)), exc_input=list(range(0, 33, 3)),
                                         **common_args)
    ...
    # f, axes = io_curve([static_runs, kcc2_runs], ifr_windowsize=ifr_windowsize, combine=True, heatmap=True,
    #                    time_points=None,
    #                    save_args=dict(fig_name="dynamic", formats=save_formats))
